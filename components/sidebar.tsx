...
import {containerVariants, textVariants, linkVariants, imageVariants, bounceVariants} from '@/utils/animations';
...
const Sidebar: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [user, tracks] = await Promise.all([getUserInfo(), getRecentTracks()]);
